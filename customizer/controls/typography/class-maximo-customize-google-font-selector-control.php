...
class Maximo_Customize_Google_Font_Selector_Control extends WP_Customize_Control {

		/**
		 * The type of control being rendered
		 */
		public $type = 'maximo-google-fonts';
			...
			if ( ! empty( $this->fontList ) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description">
						<strong><?php echo esc_html__( 'Font Family', 'maximo' );?></strong>
					</div>
					...
					<div class="customize-control-description">
						<strong><?php echo esc_html__( 'Font Variants', 'maximo' );?></strong>
					</div>
					...
					<div class="customize-control-description">
						<strong><?php echo esc_html__( 'Font Weight', 'maximo' ) ?></strong>
					</div>
					<div class="weight-style">
						<select class="google-fonts-weights" id="google-font-weight-<?php echo esc_attr( $this->id ); ?>">
							...
							if( $optionCount == 0 ) {
								...
								echo '<option value="">' . esc_html__( 'Not Available for this font', 'maximo' ) . '</option>';
							}
							?>
						</select>
					</div>
