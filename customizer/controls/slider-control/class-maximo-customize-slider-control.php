<?php
/**
 * Customizer Control: maximo-slider.
 *
 ...
 * Buttonset control
 */
if( ! class_exists( 'Maximo_Customize_Slider_Control' ) ) {

	class Maximo_Customize_Slider_Control extends WP_Customize_Control {
		...
		protected function content_template() {
			...
			<# if ( data.desktop ) { #>
				<div class="desktop control-wrap active">
					<div class="maximo-slider desktop-slider"></div>
					<div class="maximo-slider-input">
			...
			<# if ( data.tablet ) { #>
				<div class="tablet control-wrap">
					<div class="maximo-slider tablet-slider"></div>
					<div class="maximo-slider-input">
			...
			<# if ( data.mobile ) { #>
				<div class="mobile control-wrap">
					<div class="maximo-slider mobile-slider"></div>
					<div class="maximo-slider-input">
