wp.customize.controlConstructor['maximo-slider'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		var control = this,
			desktop_slider 			= control.container.find( '.maximo-slider.desktop-slider' ),
			desktop_slider_input 	= desktop_slider.next( '.maximo-slider-input' ).find( 'input.desktop-input' ),
			tablet_slider 			= control.container.find( '.maximo-slider.tablet-slider' ),
			tablet_slider_input 	= tablet_slider.next( '.maximo-slider-input' ).find( 'input.tablet-input' ),
			mobile_slider 			= control.container.find( '.maximo-slider.mobile-slider' ),
			mobile_slider_input 	= mobile_slider.next( '.maximo-slider-input' ).find( 'input.mobile-input' ),
			slider_input,
			$this,
			val;
		...
		jQuery( 'input.desktop-input' ).on( 'change keyup paste', function() {
			$this 			= jQuery( this );
			val 			= $this.val();
			slider_input 	= $this.parent().prev( '.maximo-slider.desktop-slider' );
		...
		jQuery( 'input.tablet-input' ).on( 'change keyup paste', function() {
			$this 			= jQuery( this );
			val 			= $this.val();
			slider_input 	= $this.parent().prev( '.maximo-slider.tablet-slider' );
		...
		jQuery( 'input.mobile-input' ).on( 'change keyup paste', function() {
			$this 			= jQuery( this );
			val 			= $this.val();
			slider_input 	= $this.parent().prev( '.maximo-slider.mobile-slider' );
