...
class Maximo_Customize_SlimSelect_Control extends WP_Customize_Control {

		/**
		 * The type of control being rendered
		 */
		public $type = 'maximo-slimselect-dropdown';
				...
				<?php if ( $this->choices ) {
					...
					if ( $attrs['multiselect'] ) {
						foreach ( $this->choices as $value => $label ) {
							?>
							<option value="<?php echo esc_attr( $value ); ?>" <?php selected( in_array( $val, $saved_values ) ); ?>><?php echo esc_html( $label ); ?></option>
							<?php
						}
					} else {
