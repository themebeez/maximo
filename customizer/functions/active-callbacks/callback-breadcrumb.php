 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_breadcrumb_enabled' ) ) {

	function maximo_is_breadcrumb_enabled( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_breadcrumb_placed_inside_page_header' ) ) {

	function maximo_is_breadcrumb_placed_inside_page_header( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_breadcrumb_position_placed_in_separate_container' ) ) {

	function maximo_is_breadcrumb_position_placed_in_separate_container( $control ) {
