 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_archive_width_a_narrow_width' ) ) {

	function maximo_is_archive_width_a_narrow_width( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_post_thumbnail_enabled_in_archive' ) ) {

	function maximo_is_post_thumbnail_enabled_in_archive( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_post_thumbnail_enabled_in_archive_horizontal_layout' ) ) {

	function maximo_is_post_thumbnail_enabled_in_archive_horizontal_layout( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_post_meta_enabled_in_archive' ) ) {

	function maximo_is_post_meta_enabled_in_archive( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_post_excerpt_enabled_in_archive' ) ) {

	function maximo_is_post_excerpt_enabled_in_archive( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_read_more_enabled_in_archive' ) ) {

	function maximo_is_read_more_enabled_in_archive( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_pagination_set_default_in_archive' ) ) {

	function maximo_is_pagination_set_default_in_archive( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_pagination_set_numeric_in_archive' ) ) {

	function maximo_is_pagination_set_numeric_in_archive( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_archive_layout_fullwidth' ) ) {

	function maximo_is_archive_layout_fullwidth( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_archive_layout_horizontal' ) ) {

	function maximo_is_archive_layout_horizontal( $control ) {
