 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_main_header_one_enabled' ) ) {

	function maximo_is_main_header_one_enabled( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_ad_element_enabled_on_main_header' ) ) {

	function maximo_is_ad_element_enabled_on_main_header( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_main_header_elements_section_enabled' ) ) {

	function maximo_is_main_header_elements_section_enabled( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_search_element_enabled_on_main_header' ) ) {

	function maximo_is_search_element_enabled_on_main_header( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_button_element_enabled_on_main_header' ) ) {

	function maximo_is_button_element_enabled_on_main_header( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_cart_element_enabled_on_main_header' ) ) {

	function maximo_is_cart_element_enabled_on_main_header( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_wishlist_element_enabled_on_main_header' ) ) {

	function maximo_is_wishlist_element_enabled_on_main_header( $control ) {
