 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_top_header_enabled' ) ) {

	function maximo_is_top_header_enabled( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_top_left_header_element_enabled' ) ) {

	function maximo_is_top_left_header_element_enabled( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_top_right_header_element_enabled' ) ) {

	function maximo_is_top_right_header_element_enabled( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_nav_menu_element_enabled_on_top_header' ) ) {

	function maximo_is_nav_menu_element_enabled_on_top_header( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_text_element_enabled_on_top_header' ) ) {

	function maximo_is_text_element_enabled_on_top_header( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_social_menu_element_enabled_on_top_header' ) ) {

	function maximo_is_social_menu_element_enabled_on_top_header( $control ) {
