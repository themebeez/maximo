 ...
 * @return  boolean.
 */
if( ! function_exists( 'maximo_is_banner_slider_enabled' ) ) {

	function maximo_is_banner_slider_enabled( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_banner_width_not_content_width' ) ) {

	function maximo_is_banner_width_not_content_width( $control ) {

		$is_banner_enabled = $control->manager->get_setting( 'enable_banner_slider' )->value();

		$banner_width = $control->manager->get_setting( 'banner_slider_width' )->value();

		return ( $is_banner_enabled === true && $banner_width !== 'maximo-banner-content-width' ) ? true : false;
	}
}
 ...
 * @return  boolean.
 */
if( ! function_exists( 'maximo_is_read_more_button_enabled_in_banner' ) ) {

	function maximo_is_read_more_button_enabled_in_banner( $control ) {
 ...
 * @return  boolean.
 */
if( ! function_exists( 'maximo_is_overlay_layer_enabled_in_banner' ) ) {

	function maximo_is_overlay_layer_enabled_in_banner( $control ) {
