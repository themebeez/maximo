 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_site_title_font_a_system_font' ) ) {

	function maximo_is_site_title_font_a_system_font( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_site_title_font_a_google_font' ) ) {

	function maximo_is_site_title_font_a_google_font( $control ) {
 ...
 * @return 	boolean.
 */
if ( ! function_exists( 'maximo_is_tagline_displayed' ) ) {

	function maximo_is_tagline_displayed( $control ) {
