 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_page_header_enabled' ) ) {

    function maximo_is_page_header_enabled( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_page_header_background_a_color' ) ) {

    function maximo_is_page_header_background_a_color( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_page_header_background_a_gradient' ) ) {

    function maximo_is_page_header_background_a_gradient( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_page_header_gradient_background_linear' ) ) {

    function maximo_is_page_header_gradient_background_linear( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_page_header_gradient_background_radial' ) ) {

    function maximo_is_page_header_gradient_background_radial( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_page_header_background_a_image' ) ) {

    function maximo_is_page_header_background_a_image( $control ) {
