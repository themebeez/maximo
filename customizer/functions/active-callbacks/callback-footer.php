 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_footer_widgets_enabled' ) ) {

	function maximo_is_footer_widgets_enabled( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_footer_widgets_columns_2' ) ) {

	function maximo_is_footer_widgets_columns_2( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_footer_widgets_columns_3' ) ) {

	function maximo_is_footer_widgets_columns_3( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_footer_copyright_section_layout_one' ) ) {

	function maximo_is_footer_copyright_section_layout_one( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_text_element_enabled_in_copyright_section' ) ) {

	function maximo_is_text_element_enabled_in_copyright_section( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_nav_menu_element_enabled_in_copyright_section' ) ) {

	function maximo_is_nav_menu_element_enabled_in_copyright_section( $control ) {
 ...
 * @return  boolean.
 */
if ( ! function_exists( 'maximo_is_social_links_element_enabled_in_copyright_section' ) ) {

	function maximo_is_social_links_element_enabled_in_copyright_section( $control ) {
