...
if ( ! function_exists( 'maximo_is_transparent_header_activated' ) ) {

	function maximo_is_transparent_header_activated() {

		if ( ! maximo_get_option( 'enable_transparent_header' ) ) {

			return false;
		}

		$transparent_header_enabled_pages = maximo_get_option( 'enable_transparent_header_on_pages' );
		...
		if ( $transparent_header_enabled_pages ) {
				...
				if ( class_exists( 'WooCommerce' ) && is_woocommerce() ) {
					...
					if ( is_single() ) {
						...
						if ( ! in_array( 'post_single', $transparent_header_enabled_pages )  ) {
							...
							$disable_transparent_header = ( get_post_meta( get_the_ID(), 'maximo_post_disable_transparent_header', true ) ) ? true : false;
			...
			$classes[] = 'maximo-transparent-header-disabled';
		}
	}
}

if ( ! function_exists( 'maximo_is_page_header_activated' ) ) {

	function maximo_is_page_header_activated() {

		if ( ! maximo_get_option( 'enable_page_header' ) ) {

			return false;
		}

		$page_header_enabled_pages = maximo_get_option( 'page_header_display_pages' );
				...
				if ( class_exists( 'WooCommerce' ) && is_woocommerce() ) {
					...
					if ( is_single() ) {
						...
						if ( ! in_array( 'post_single', $page_header_enabled_pages )  ) {
							...
							$disable_page_header = ( get_post_meta( get_the_ID(), 'maximo_post_disable_page_header', true ) ) ? true : false;
...
if ( ! function_exists( 'maximo_is_breadcrumbs_activated' ) ) {

	function maximo_is_breadcrumbs_activated() {

		if ( ! maximo_get_option( 'enable_breadcrumbs' ) ) {

			return false;
		}

		$breadcrumbs_enabled_pages = maximo_get_option( 'breadcrumbs_display_pages' );
				...
				if ( class_exists( 'WooCommerce' ) && is_woocommerce() ) {
					...
					if ( is_single() ) {
						...
						if ( ! in_array( 'post_single', $breadcrumbs_enabled_pages )  ) {
							...
							$disable_breadcrumb = ( get_post_meta( get_the_ID(), 'maximo_post_disable_breadcrumb', true ) ) ? true : false;
...
if ( ! function_exists( 'maximo_is_banner_activated' ) ) {

	function maximo_is_banner_activated() {
...
if ( ! function_exists( 'maximo_is_categories_in_post_structure' ) ) {

	function maximo_is_categories_in_post_structure() {
		...
		if ( is_home() || is_archive() || is_search() ) {
			...
			switch ( $archive_layout ) {				
				case 'horizontal-list' :
					$post_elements = maximo_get_option( 'archive_horizontal_list_post_structure' );
					break;
				default :
					$post_elements = maximo_get_option( 'archive_fullwidth_post_structure' );
					break;
			}
		...
		if ( is_single() ) {
			...
			$post_elements = maximo_get_option( 'single_post_elements' );
...
if ( ! function_exists( 'maximo_is_meta_in_post_meta' ) ) {

	function maximo_is_meta_in_post_meta( $search_item ) {

		if ( is_home() || is_archive() || is_search() ) {

			$post_elements = maximo_get_option( 'archive_post_meta' );
		...
		if ( is_single() ) {
			...
			$post_elements = maximo_get_option( 'single_post_meta' );
...
if ( ! function_exists( 'maximo_is_post_meta_active' ) ) {

	function maximo_is_post_meta_active() {
...
if ( ! function_exists( 'maximo_is_post_content_element_enabled' ) ) {

	function maximo_is_post_content_element_enabled( $search_item ) {
...
if ( ! function_exists( 'maximo_is_meta_icon_enabled' ) ) {

	function maximo_is_meta_icon_enabled() {

		if ( is_archive() || is_home() || is_search() ) {

			if ( maximo_get_option( 'archive_show_icons_in_post_meta' ) ) {
				return true;
			}
		}
		...
		if ( is_single() ) {
			...
			if ( maximo_get_option( 'single_show_icons_in_post_meta' ) ) {
				return true;
			}
		}
	}
...
if ( ! function_exists( 'maximo_is_breadcrumbs_in_separate_container' ) ) {

	function maximo_is_breadcrumbs_in_separate_container() {
		...
		if ( maximo_is_page_header_activated() ) {
			...
			return ( maximo_get_option( 'breadcrumbs_position' ) == 'default' ) ? true : false;
		}
...
if ( ! function_exists( 'maximo_get_sidebar_position' ) ) {

	function maximo_get_sidebar_position() {

		$default_sidebar_position = maximo_get_option( 'sidebar_default_position' );

		if ( maximo_is_woocommerce_page() ) {

			return maximo_get_woocommerce_sidebar_position();
			...
			if ( is_home() || is_search() || is_archive() ) {
				...
				$archive_sidebar_position = maximo_get_option( 'sidebar_archives_and_search_position' );
			...
			if ( is_single() || is_page() ) {
				...
				$single_sidebar_position = ( is_single() ) ? maximo_get_option( 'sidebar_post_single_position' ) : maximo_get_option( 'sidebar_page_single_position' );

				$single_sidebar_position_meta = get_post_meta( get_the_ID(), 'maximo_post_sidebar_position', true );
...
if ( ! function_exists( 'maximo_is_sidebar_active' ) ) {

	function maximo_is_sidebar_active() {
...
if ( ! function_exists( 'maximo_is_page_header_background_image_active' ) ) {

	function maximo_is_page_header_background_image_active() {

		if ( maximo_is_page_header_activated() ) {

			$background_type = maximo_get_option( 'page_header_background_type' );
...
if ( ! function_exists( 'maximo_is_woocommerce_page' ) ) {

	function maximo_is_woocommerce_page() {
...
if ( ! function_exists( 'maximo_get_woocommerce_sidebar_position' ) ) {

	function maximo_get_woocommerce_sidebar_position() {

		if ( ! is_active_sidebar( 'maximo-woocommerce-sidebar' ) ) {
			return 'no-sidebar';
		}
		...
		if ( is_product() ) {
			...
			$product_sidebar_position = maximo_get_option( 'sidebar_woocommerce_product_position' );
		...
		if ( is_product_category() || is_product_tag() || is_shop() ) {
			...
			$archive_sidebar_position = maximo_get_option( 'sidebar_woocommerce_archive_position' );
		...
		if ( is_cart() || is_checkout() || is_account_page() ) {
			...
			$page_sidebar_position = maximo_get_option( 'sidebar_page_single_position' );

			$page_sidebar_position_meta = get_post_meta( get_the_ID(), 'maximo_post_sidebar_position', true );
